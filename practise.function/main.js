...
// console.log(findFirstNotRepeatedChar('abacddbeczzz'));
...
//   }
//   return findStr;
// str.split('').find((item,index)=>)
// }
// console.log(findFirstNotRepeatedChar("abacddbeczzzs"));
...
function charCount(arg,item){
   let findarg=0;
   for(let i=0;i<arg.length;i++){
   arg[i]==item && (findarg+=1)
